    ...
    uniqueRuas.forEach((val1, index1) => {
      ...
      bagiHasilSettlement.forEach((val2, index2) => {
        if (uniqueRuas[index1] === val2.RUAS_CODE) {
          bagiHasil[index1]['ruas'] = val2.RUAS_CODE
          bagiHasil[index1]['date'] = val2.MONTH + '-' + val2.YEAR
          bagiHasil[index1]['rencana'].push(val2.RENCANA)
          bagiHasil[index1]['realisasi'].push(val2.REALISASI)
          bagiHasil[index1]['rencana_lalin'].push(val2.RENCANA_LALIN)
          bagiHasil[index1]['realisasi_lalin'].push(val2.REALISASI_LALIN)
        }
      })
    })
    console.table(bagiHasilSettlement)
