...
class AccidentDescription extends Component {
  ...
  componentWillMount() {
    if (this.props.isCommandCenter) {
      this.setState({
        style: {
          backgroundColor: 'rgba(0,0,0,0.1)', border: '1px solid rgba(255, 255, 255, 0.2)', color: '#fff', borderRadius: '20px'
        }
      });
    }
  }
  ...
  render() {
    ...
    return (
      <Card style={this.state.style}>
        <CardHeader style={{ backgroundColor: 'rgba(0,0,0,0.0)', border: 'none', color: '#fff' }}>
