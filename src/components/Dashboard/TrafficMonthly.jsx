...
class TrafficMonthly extends Component {
  constructor(props) {
    super(props);
    this.state = {
      title: 'Monthly Monitoring Traffic',
  ...
  componentWillReceiveProps(nextProps) {
    ...
    if (this.props.monthlyTransactionByRealisasi !== nextProps.monthlyTransactionByRealisasi) {
      ...
      setTimeout(function () {
        self.setState({
          dataSet: nextProps.monthlyTransactionByRealisasi.data_trafic,
          dataRaw: nextProps.monthlyTransactionByRealisasi.data_trafic
        });
      }, 1);
    }
  }
...
export default connect(mapStateToProps)(TrafficMonthly)